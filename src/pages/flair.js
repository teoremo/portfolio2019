    ...
    <svg className="background-svg" width="4113" height="8000" viewBox="0 0 4113 8000"  fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <stop offset="1" stop-color="#C30000"/>
          ...
          <div className="project__hero__img">
            ...
            <Projectintro 
            image={<Img className="image-l" fluid={props.data.imageCover.childImageSharp.fluid} />}
