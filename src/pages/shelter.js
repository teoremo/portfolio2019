  ...
  <defs>
    ...
    <linearGradient id="paint0_linear" x1="3157.95" y1="5243" x2="1620.89" y2="911.14" gradientUnits="userSpaceOnUse">
      ...
      <div className="project__article__page">
        <div className="project__article__wrapper">
          <p className="project__article__p">
            As I was asked to implement digital products, I realized that
            influencing longer term strategy would’ve taken longer.
            <br />
            <strong>
              I figured out that &lsquo;starting small&rsquo; would’ve been the
              best approach.
            </strong>
            <br />
            This allowed our team to build trust among stakeholders while
            guiding them along the design process and addressing things they
            cared about.
            <br />
            <br />
            That’s when Service Design started to gain genuine interest. <br />
            ...
            and interventions that would’ve get Shelter closer to the ideal
            advice journey envisioned earlier.
            <br />
            <br />
            As a team we then went on exploring these opportunities. <br />
